...
<html>
    ...
    <body>
         <div class='font-moonlight'>
            <nav class="navbar navbar-expand-lg navbar-light bg-light col-12 col-md-12 nav-fix">
            ...
            <div class="dropdown">
                <button class="dropnabtn"><img src="Icon/arrow.png" width="2%" class="margin-icon">search by . .</button>
